...
<tr> 
	<td style="padding:24px 24px 16px"> 
		...
		<p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;">
		    Vaš kolega, <b><?= $engineer->name ?></b>, <?= $engineer->title ?> pozvao Vas je na <?= Yii::$app->name ?>.  <a href="http://masterplan.rs/user/register">Klikom na ovaj link</a>, možete započeti jednostavnu i brzu registraciju.
		</p>
