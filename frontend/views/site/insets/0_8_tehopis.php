...
<div style="margin: 20px;">
	...
	<h3 class="sub">Arhitektonsko rešenje</h3>
		<h4 class="nopadd">Prostorna organizacija objekta</h4>
		...
		<h4 class="nopadd">Položaj objekta</h4>
		tip (ugaoni,u nizu...)
		<h4 class="nopadd">Dimenzije i oblik objekta</h4>
		<p>Dužina, širina, visina, spratnost, površina.</p>
		<h4 class="sub">Dispozicija i funkcija objekta</h4>
