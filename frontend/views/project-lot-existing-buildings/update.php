...
$this->title = 'Podešavanje postojećeg objekta na parceli';

$this->params['page_title'] = 'Lokacija';
$this->params['page_title_2'] = 'Postojeći objekat';
...
<div class="card_container record-full grid-item fadeInUp no-shadow no-margin animated-not" id="">
    <div class="primary-context normal aliceblue bottom-bordered">
        <div class="head colos">
        	<div class="subaction">
        		<?= Html::a('<i class="fa fa-plus fa-2x"></i>', Url::to(['/project-lot-existing-buildings/create', 'ProjectLotExistingBuildings[project_id]'=>$model->project->id]), ['class' => 'btn btn-link']) ?>
        		<?= Html::a('<i class="fa fa-life-saver fa-2x"></i>', null, ['class' => 'btn btn-link button_to_show_secondary']) ?>
       		</div>
       		<i class="fa fa-copy"></i> Postojeći objekti na parceli
        </div>
        <div class="subhead">Upravljanje postojećim objektima na predmetnoj parceli/parcelama projekta.</div>
    </div>  
