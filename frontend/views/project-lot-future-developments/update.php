...
$this->title = 'Podešavanje predviđenog objekta na parceli';

$this->params['page_title'] = 'Lokacija';
$this->params['page_title_2'] = 'Predviđeni objekat';
...
<div class="card_container record-full grid-item fadeInUp no-shadow no-margin animated-not" id="">
    <div class="primary-context normal aliceblue bottom-bordered">
        <div class="head colos">
        	<div class="subaction">
        		<?= Html::a('<i class="fa fa-plus fa-2x"></i>', Url::to(['/project-lot-future-developments/create', 'ProjectLotFutureDevelopments[project_id]'=>$model->project->id]), ['class' => 'btn btn-link']) ?>
