...
<?php $form = kartik\widgets\ActiveForm::begin([
    ...
    <?= $form->field($model, 'name')->textInput(['maxlength' => true])->hint('Pun poslovni naziv firme. Npr: Preduzeće d.o.o. Beograd') ?>

<hr> 
<h6>Adresa firme</h6>
    <?= $form->field($location, 'street')->textInput(['maxlength' => true]) ?>
    <?php // $form->field($location, 'number')->textInput(['maxlength' => true]) ?>
