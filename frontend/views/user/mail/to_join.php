...
<tr> 
    <td style="padding:24px 24px 16px"> 
        <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;">
            Poštovani kolega <?= $model->engineer->name ?>,
        </p>
        <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;">
            Preduzeće <b><?= $model->practice->name ?></b> uputilo Vam je poziv da postanete <?= $model->position ?> tog preduzeća i na taj način proširite svoju poslovno-stručnu mrežu.  
        </p>

        <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;">
            <a href="http://masterplan.rs/practiceEngineers/confirm?id=<?= $model->id ?>" class="btn btn-default">Klikom na ovaj link</a>, potvrđujete poziv u preduzeće <?= $model->practice->name ?> i postajete njegov <?= $model->position ?>.
        </p>
    </td> 
</tr> 
