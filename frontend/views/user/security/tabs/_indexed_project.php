            ...
            <div class="row">
                ...
                <div class="col-sm-10">     
                    ...
                    <div class="head lower">
                        <?= \yii\helpers\StringHelper::truncate($model->name, 50) ?>
                        
                    </div>
                    <div class="subhead" style="margin-top:10px;">
                        <i class="fa fa-globe"></i>&nbsp;<?= $model->location->city->town ?> | <i class="fa fa-home"></i>&nbsp;<?= $model->projectBuilding ? $model->projectBuilding->name : $model->projectExBuilding->name ?>
                    </div>
