...
<div class="primary-context normal bottom-bordered">
    <div class="head lower button_to_show_secondary">
        ...
        Instalacije</div>
    <div class="subhead">Instalacije objekta.</div>
</div>
<div class="primary-context gray" style="display: none;">
    ...
    <div class="form-group">    
        <div class="col-sm-5">
            <?= $form->field($model, '[existing]general_service',['showLabels'=>false])->textarea(['rows' => 6, 'placeholder'=>$model->placeholderGeneral])->hint($model->hintGeneral) ?>
        </div>
        <div class="col-sm-2 center">
            <?= Html::activeLabel($model, 'general_service', []) ?>
        </div>
        <div class="col-sm-5">
            <?= $form->field($model_new, '[new]general_service',['showLabels'=>false])->textarea(['rows' => 6, 'placeholder'=>$model->placeholderGeneral])->hint($model->hintGeneral) ?>
        </div>
    </div>
    ...
    <?php else: ?>
        <?= $form->field($model, 'general_service')->textarea(['rows' => 6, 'placeholder'=>$model->placeholderGeneral])->hint($model->hintGeneral) ?>
        <hr>
