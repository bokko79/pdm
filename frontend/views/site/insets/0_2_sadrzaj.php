...
<?php endif; ?>
	<tr>
		<td class="">0.<?= ($model->phase=='idp' or $model->phase=='pgd' or $model->phase=='pzi' or $model->phase=='pio') ? '5' : '3' ?>.</td>
		<td class="content">
			<p>Sadržaj tehničke dokumentacije</p>
		</td>
	</tr>
	<tr>
		<td class="">0.<?= ($model->phase=='idp' or $model->phase=='pgd' or $model->phase=='pzi' or $model->phase=='pio') ? '6' : '4' ?>.</td>
		<td class="content">
			<p>Podaci o projektantima</p>
		</td>
	</tr>
	<tr>
		<td class="">0.<?= ($model->phase=='idp' or $model->phase=='pgd' or $model->phase=='pzi' or $model->phase=='pio') ? '7' : '5' ?>.</td>
		<td class="content">
...
<?php endif; ?>
<?php if($model->checkIfElaborat and $model->phase=='idp' or $model->phase=='pgd'): ?>
	<tr>
		<td class="">0.9.</td>
		<td class="content">
...
<?php if($model->phase=='pgd' or $model->phase=='pio'): ?>
	<tr>
		<td class="">0.<?= ($model->checkIfElaborat and $model->phase=='pgd') ? '10' : '9' ?>.</td>
		<td class="content">
