...
{     
    ...
    {         
        ...
        if ($item->name === 'owner') {
            ...
            return $role == 'owner' || $role == 'admin' || $role == 'editor' || $role == 'engineer' || $role == NULL; //user is a child of editor and admin, if we have no role defined this is also the default role
        } else {
            return false;
        }
    }
