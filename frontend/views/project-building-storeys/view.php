        ...
        <div class="col-sm-9">
            ...
            <div class="card_container record-full grid-item fadeInUp animated" id="">
                <div class="primary-context gray normal">
                    <div class="head"><?= Html::a(c('<i class="fa fa-home"></i> '.$model->projectBuilding->name), Url::to(['/project-building-storeys/index', 'id'=>$model->project_building_id])) ?> <i class="fa fa-arrow-circle-right hint small"></i> <?= c($model->name) ?>: Lista jedinica (celina)
                    <?php if(!$model->sameAs): ?>
