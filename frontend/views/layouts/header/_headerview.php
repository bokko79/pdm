                        ...
                        <div class="subhead" style="margin-bottom:10px;">
                         ...
                         <?php if(\Yii::$app->user->can('updateOwnProject', ['project'=>$model])): ?>   
                            <div class="action-area normal-case">
                                ...
                                <a href="#" data-toggle="dropdown" class="dropdown-toggle btn btn-default shadow btn-success"><i class="fa fa-cog"></i> Podešavanje projekta <i class="fa fa-caret-down"></i></a>
                                <?php
                            ...
                            <?php endif; ?>
                            <?= Html::a(\yii\helpers\StringHelper::truncate($model->name, 40) . ($model->work!='adaptacija' ? ' ('.(($model->projectBuilding) ? $model->projectBuilding->spratnost : $model->projectExBuilding->spratnost).')' : null), Url::to(['/projects/view', 'id'=>$model->id]), ['class'=>'']) ?>
                        </div>
