...
/**
 * ProjectBuildingMaterialsSearch represents the model behind the search form about `common\models\ProjectBuildingMaterials`.
 */
class ProjectBuildingMaterialsSearch extends ProjectBuildingMaterials
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = ProjectBuildingMaterials::find();
