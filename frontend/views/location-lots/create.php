...
$this->title = 'Dodavanje katastarske parcele';


$this->params['page_title'] = 'Lokacija';
$this->params['page_title_2'] = 'Nova katastarska parcela';
...
<div class="card_container record-full grid-item fadeInUp no-shadow no-margin animated-not" id="">
    <div class="primary-context normal aliceblue bottom-bordered">
        <div class="head colos">
        	<div class="subaction">
        		<?= Html::a('<i class="fa fa-plus fa-2x"></i> Građevinska', Url::to(['/location-lots/create', 'LocationLots[location_id]'=>$model->location_id, 'LocationLots[type]'=>'object']), ['class' => 'btn btn-link']) ?>
