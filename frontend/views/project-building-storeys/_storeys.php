	...
	<div class="row">		
		<div class="col-sm-12">
			<table class="table table-striped table-hover table-bordered">
				...
				<tr>
					<td class="center">
						<?= (!$model->s) ? Html::a(Yii::t('app', '<i class="fa fa-plus-circle"></i> Dodaj suteren'), ['/project-building/storeys', 'id' => $model->id, 'add_storey'=>'suteren'], [ 'class' => 'btn btn-primary', 'data' => ['method' => 'post',], 'style'=>'width:100%;']) : Html::button(Yii::t('app', 'Suteren'), [ 'class' => 'btn btn-default', 'disabled' => 'disabled', 'style'=>'width:100%;']); ?>
					</td>
					<td>
						<?= ($model->s) ? Html::a($model->s->name ? c($model->s->name) : c($model->s->storey), Url::to(['/project-building-storeys/view', 'id'=>$model->s->id]), ['class' => 'btn btn-default btn-sm']). ' '.Html::a('<i class="fa fa-wrench"></i>', Url::to(['/project-building-storeys/update', 'id'=>$model->s->id]), ['class' => 'btn btn-success btn-sm']). ' ' .((!$model->s->projectBuildingStoreyParts) ? Html::a('<i class="fa fa-power-off"></i>', Url::to(['/project-building/storeys', 'id' => $model->id, 'remove_storey'=>$model->s->id]), ['class' => 'btn btn-danger btn-sm', 'data' => [
                'confirm' => Yii::t('app', 'Da li ste sigurni da želite da obrišete celu etažu. Brisanjem etaže, obrisaćete i njene jedinice i prostorije, a proces ne može biti povraćen.'),
				...
				<tr>
					<td class="center">
						<?= (!$model->g) ? Html::a(Yii::t('app', '<i class="fa fa-plus-circle"></i> Dodaj galeriju'), ['/project-building/storeys', 'id' => $model->id, 'add_storey'=>'galerija'], [ 'class' => 'btn btn-primary', 'data' => ['method' => 'post',], 'style'=>'width:100%;']) : Html::button(Yii::t('app', 'Galerija'), [ 'class' => 'btn btn-default', 'disabled' => 'disabled', 'style'=>'width:100%;']); ?>
					</td>
					<td>
						<?= ($model->g) ? Html::a($model->g->name ? c($model->g->name) : c($model->g->storey), Url::to(['/project-building-storeys/view', 'id'=>$model->g->id]), ['class' => 'btn btn-default btn-sm']). ' '.Html::a('<i class="fa fa-wrench"></i>', Url::to(['/project-building-storeys/update', 'id'=>$model->g->id]), ['class' => 'btn btn-success btn-sm']). ' ' .((!$model->g->projectBuildingStoreyParts) ? Html::a('<i class="fa fa-power-off"></i>', Url::to(['/project-building/storeys', 'id' => $model->id, 'remove_storey'=>$model->g->id]), ['class' => 'btn btn-danger btn-sm', 'data' => [
                'confirm' => Yii::t('app', 'Da li ste sigurni da želite da obrišete celu etažu. Brisanjem etaže, obrisaćete i njene jedinice i prostorije, a proces ne može biti povraćen.'),
				...
				<tr>
					<td class="center">						
						<?= Html::a(Yii::t('app', '<i class="fa fa-plus-circle"></i> Dodaj sprat'), ['/project-building/storeys', 'id' => $model->id, 'add_storey'=>'sprat'], [ 'class' => 'btn btn-primary', 'data' => ['method' => 'post',], 'style'=>'width:100%;']) ?>
					</td>
					<td>
						<?php 
							if($model->sp){
				...
				<tr>
					<td class="center">
						...
						<?= Html::a(Yii::t('app', '<i class="fa fa-plus-circle"></i> Dodaj povučeni sprat'), ['/project-building/storeys', 'id' => $model->id, 'add_storey'=>'povucenisprat'], [ 'class' => 'btn btn-primary', 'data' => ['method' => 'post',], 'style'=>'width:100%;']) ?>
					</td>
					<td>
						<?php 
							if($model->ps){
								foreach($model->ps as $ps){
									echo Html::a($ps->name ? c($ps->name) : c($ps->storey), Url::to(['/project-building-storeys/view', 'id'=>$ps->id]), ['class' => 'btn btn-default btn-sm']). ' '.Html::a('<i class="fa fa-wrench"></i>', Url::to(['/project-building-storeys/update', 'id'=>$ps->id]), ['class' => 'btn btn-success btn-sm']). ' ' .((!$ps->projectBuildingStoreyParts) ? Html::a('<i class="fa fa-power-off"></i>', Url::to(['/project-building/storeys', 'id' => $model->id, 'remove_storey'=>$ps->id]), ['class' => 'btn btn-danger btn-sm', 'data' => [
                'confirm' => Yii::t('app', 'Da li ste sigurni da želite da obrišete celu etažu. Brisanjem etaže, obrisaćete i njene jedinice i prostorije, a proces ne može biti povraćen.'),
				...
				<tr>
					<td class="center">
						...
						<?= Html::a(Yii::t('app', '<i class="fa fa-plus-circle"></i> Dodaj mansardu'), ['/project-building/storeys', 'id' => $model->id, 'add_storey'=>'mansarda'], [ 'class' => 'btn btn-primary', 'data' => ['method' => 'post',], 'style'=>'width:100%;']) ?>
					</td>
					<td>
						<?php 
							if($model->m){
								foreach($model->m as $m){
									echo Html::a($m->name ? c($m->name) : c($m->storey), Url::to(['/project-building-storeys/view', 'id'=>$m->id]), ['class' => 'btn btn-default btn-sm']). ' '.Html::a('<i class="fa fa-wrench"></i>', Url::to(['/project-building-storeys/update', 'id'=>$m->id]), ['class' => 'btn btn-success btn-sm']). ' ' .((!$m->projectBuildingStoreyParts) ? Html::a('<i class="fa fa-power-off"></i>', Url::to(['/project-building/storeys', 'id' => $model->id, 'remove_storey'=>$m->id]), ['class' => 'btn btn-danger btn-sm', 'data' => [
                'confirm' => Yii::t('app', 'Da li ste sigurni da želite da obrišete celu etažu. Brisanjem etaže, obrisaćete i njene jedinice i prostorije, a proces ne može biti povraćen.'),
				...
				<tr>
					<td class="center">
						...
						<?= Html::a(Yii::t('app', '<i class="fa fa-plus-circle"></i> Dodaj potkrovlje'), ['/project-building/storeys', 'id' => $model->id, 'add_storey'=>'potkrovlje'], [ 'class' => 'btn btn-primary', 'data' => ['method' => 'post',], 'style'=>'width:100%;']) ?>
					</td>
					<td>
						<?php 
							if($model->pk){
								foreach($model->pk as $pk){
									echo Html::a($pk->name ? c($pk->name) : c($pk->storey), Url::to(['/project-building-storeys/view', 'id'=>$pk->id]), ['class' => 'btn btn-default btn-sm']). ' '.Html::a('<i class="fa fa-wrench"></i>', Url::to(['/project-building-storeys/update', 'id'=>$pk->id]), ['class' => 'btn btn-success btn-sm']). ' ' .((!$pk->projectBuildingStoreyParts) ? Html::a('<i class="fa fa-power-off"></i>', Url::to(['/project-building/storeys', 'id' => $model->id, 'remove_storey'=>$pk->id]), ['class' => 'btn btn-danger btn-sm', 'data' => [
                'confirm' => Yii::t('app', 'Da li ste sigurni da želite da obrišete celu etažu. Brisanjem etaže, obrisaćete i njene jedinice i prostorije, a proces ne može biti povraćen.'),
				...
				<tr>
					<td class="center" style="width: 30%;">
						<?= (!$model->t) ? Html::a(Yii::t('app', '<i class="fa fa-plus-circle"></i> Dodaj tavan'), ['/project-building/storeys', 'id' => $model->id, 'add_storey'=>'tavan'], [ 'class' => 'btn btn-primary', 'data' => ['method' => 'post',], 'style'=>'width:100%;']) : Html::button(Yii::t('app', 'Tavan'), [ 'class' => 'btn btn-default', 'disabled' => 'disabled', 'style'=>'width:100%;']); ?>
					</td>
					<td>
						<?= ($model->t) ? Html::a($model->t->name ? c($model->t->name) : c($model->t->storey), Url::to(['/project-building-storeys/view', 'id'=>$model->t->id]), ['class' => 'btn btn-default btn-sm']). ' '.Html::a('<i class="fa fa-wrench"></i>', Url::to(['/project-building-storeys/update', 'id'=>$model->t->id]), ['class' => 'btn btn-success btn-sm']). ' ' .((!$model->t->projectBuildingStoreyParts) ? Html::a('<i class="fa fa-power-off"></i>', Url::to(['/project-building/storeys', 'id' => $model->id, 'remove_storey'=>$model->t->id]), ['class' => 'btn btn-danger btn-sm', 'data' => [
                'confirm' => Yii::t('app', 'Da li ste sigurni da želite da obrišete celu etažu. Brisanjem etaže, obrisaćete i njene jedinice i prostorije, a proces ne može biti povraćen.'),
