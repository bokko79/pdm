                ...
                <hr>
                    ...
                    <?= $form->field($model, 'stampFile')->widget(FileInput::classname(), [
                            ...
                            'pluginOptions' => [
                                ...
                                'browseLabel' =>  Yii::t('app', 'Prikačite skenirani licencni pečat'),
                        ...
                        ])->hint('Prikačite skenirani licencni (šestougaoni) pečat Inženjerske komore Srbije u .jpg ili .png formatu.') ?>
